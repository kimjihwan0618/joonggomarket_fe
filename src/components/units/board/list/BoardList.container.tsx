...
export default function BoardList() {
  ...
  const [fetchBoards, { data: boards }] = useLazyQuery<Pick<IQuery, 'fetchBoards'>, IQueryFetchBoardsArgs>(FETCH_BOARDS);
  const [fetchBoardsCount, { data: boardsPageCount }] = useLazyQuery<Pick<IQuery, 'fetchBoardsCount'>, IQueryFetchBoardsCountArgs>(FETCH_BOARDS_COUNT);
